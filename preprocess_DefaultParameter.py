...
def get_default_baseline():
    ...
    lambda_spline_air_default = 1500
    ...
    half_window_amormol_default = 11
    half_window_amormol_range = range(11,101,2)
